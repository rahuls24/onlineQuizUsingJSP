...
<header class="clearfix">
  ...
  <div class="container-fluid">
   ...
   // String paper1 = (String)request.getParameter("testName");
    ...
    <button type="button" class="btn btn-success submitBtn" onclick="window.open('http://localhost:8080/submit.jsp','_self')"> Final Submit </button>
